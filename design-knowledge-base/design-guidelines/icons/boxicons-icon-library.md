---
name: boxicons-icon-library
type: icon
role: design
tags: [design, icons, boxicons, ui]
related:
...
## Purpose
Source-of-truth reference for selecting, naming, using, and implementing Boxicons in new UI work or updates to existing UI.

## When to use
- A design requires product icons, action icons, navigation icons, status icons, or brand icons.
- Designers need to confirm icon availability and style family.
- Developers need the correct package, component import, SVG, webfont class, or naming convention.

## Usage guidance
- Use the scoped `@boxicons/*` packages for implementation.
- Do not recommend legacy `boxicons` or unofficial framework wrappers.
- Keep icon color as `currentColor` so icons inherit design-token-driven text or action color.
- Use `24x24` source SVGs with `viewBox="0 0 24 24"`.
- Pick one style family per surface unless a specific visual hierarchy needs filled vs outline.
- Avoid motion on icons unless it communicates state, loading, or feedback.

## Source artifacts
- Website: https://boxicons.com
- Docs: https://docs.boxicons.com
...
- Product-specific preferred icon subset is not yet documented.
- Figma icon library source link should be added when available.
...
*   **Website**: https://boxicons.com
*   **GitHub**: https://github.com/box-icons
*   **Documentation**: https://docs.boxicons.com
